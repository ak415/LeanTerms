...
>>>>>>> 1a4abb6f8742f0d803d6ad98da73169e3fb624c6
    }
  }
                ...
                <div id="id01" className="modal">
                  <form className="modal-content">
                    <div className="container">
                      ...
                      <input type="text" placeholder="Enter Email" name="psw" onChange={this.update('email')} required/>

                      <label><b>Password</b></label>
                      <input type="password" placeholder="Enter Password" name="psw-repeat" onChange={this.update('password')} required/>



                      <div className="clearfix">
                        <button type="submit" className="signup" onClick={this.handlesubmitnewuser}>Sign Up</button>
                    ...
                    <div id="id02" className="modal">
                          <form className="modal-content">
                            <div className="container">
                              ...
                              <div className="clearfix">
                                <button type="submit" className="signup" onClick={this.handlesubmitlogin}>Log In</button>
